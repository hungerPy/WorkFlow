<%@ Page Language="VB" AutoEventWireup="false" CodeFile="printappdetails.aspx.vb" MasterPageFile="MasterPage.master" Inherits="Admin_printappdetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" Runat="Server">
    <title>Director Edit Preview</title>
     <link rel="icon" href="images/hslogo.jpg" type="image/x-icon"/>
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" Runat="Server"> 

    <div>
         <asp:DataList ID="dlstMain" runat="server" Width="97%" DataKeyField="dirid" Visible="True" RepeatColumns ="1">
        <ItemTemplate >
        ...
        <b><span style=" font-size :large ; ">Director Profile & Details</span> </b>
              
            </td></tr>
            <tr style="background-color :#E1E1E1 ; line-height:20px;">
            <td align="left"  colspan="4" style=" padding-left :10px;">Record No. :<b> <%#DataBinder.Eval(Container.DataItem, "dirid")%></b></td>
            ...
            <tr style="background-color :#E1E1E1 ; line-height:20px;">
             ...
             <asp:Label ID="lblname" runat="server"  Font-Names="Verdana" Font-Size="9pt" ><%#DataBinder.Eval(Container.DataItem, "Aini") & " " & DataBinder.Eval(Container.DataItem, "dirName")%></asp:Label>
            </td>
            ...
            <tr style="background-color :#E1E1E1 ; line-height:20px;">
               ...
               <td align="left" style=" padding-left :10px;width :40%" colspan="2">
               <asp:Label ID="lbldirname1" runat="server"  Font-Names="Verdana" Font-Size="9pt" ><%#DataBinder.Eval(Container.DataItem, "Aini") & " " & DataBinder.Eval(Container.DataItem, "dirName")%></asp:Label><br />
               <asp:Label ID="lblpfix" runat="server" Font-Bold="true"  ><%#DataBinder.Eval(Container.DataItem, "pfix")%> </asp:Label>-<asp:Label ID="lbldirfname" runat="server"  Font-Names="Verdana" Font-Size="9pt" ><%#DataBinder.Eval(Container.DataItem, "Fini") & " " & DataBinder.Eval(Container.DataItem, "FatherName")%></asp:Label><br />
             <asp:Label ID="lblpresentaddress" runat="server"  Font-Names="Verdana" Font-Size="9pt" ><%#DataBinder.Eval(Container.DataItem, "Address")%></asp:Label> <asp:Label ID="lblgram" runat="server"   Font-Names="Verdana" Font-Size="9pt" ></asp:Label> <asp:Label ID="lblpanchayat" runat="server"   Font-Names="Verdana" Font-Size="9pt" ></asp:Label><asp:Label ID="lbltehsil" runat="server"   Font-Names="Verdana" Font-Size="9pt" ></asp:Label>    <asp:Label ID="lblcity" runat="server"   Font-Names="Verdana" Font-Size="9pt" ></asp:Label> <asp:Label ID="lblstate" runat="server"   Font-Names="Verdana" Font-Size="9pt" ></asp:Label><asp:Label ID="lblpin" runat="server"   Font-Names="Verdana" Font-Size="9pt" ><%#", Pincode : " & DataBinder.Eval(Container.DataItem, "pincode")%></asp:Label>
               ...
               <td align="left" style=" padding-left :10px;width :40%" colspan="2">
               <asp:Label ID="lbldirname2" runat="server"  Font-Names="Verdana" Font-Size="9pt" ><%#DataBinder.Eval(Container.DataItem, "Aini") & " " & DataBinder.Eval(Container.DataItem, "dirName")%></asp:Label><br />
               <asp:Label ID="lblpfix1" runat="server" Font-Bold="true"  ><%#DataBinder.Eval(Container.DataItem, "pfix")%> </asp:Label>-<asp:Label ID="lbldirfname1" runat="server"  Font-Names="Verdana" Font-Size="9pt" ><%#DataBinder.Eval(Container.DataItem, "Fini") & " " & DataBinder.Eval(Container.DataItem, "FatherName")%></asp:Label><br />
    ...
    <tr style="background-color :#EEEEEE ;" ><td colspan="4"  width="100%" align ="center" >
        ...
        <table  width="100%"><tr style="background-color :#E1E1E1 ;"><td align="center" ><asp:Button ID="btnReconfirm" CssClass ="btn btn-success " runat="server" Text="Submit" Width="100px" Height="20px"></asp:Button>&nbsp;&nbsp;<asp:Button ID="btnedit" Width="70px" CssClass ="btn btn-warning " runat="server" Text="Edit" Height="20px"></asp:Button>&nbsp;&nbsp;<asp:Button ID="btnpreview" Width="70px" runat="server" CssClass ="btn btn-info " Text="Print" Height="20px"></asp:Button></td></tr></table>
    </div>
   </asp:Content>
