<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ClientListing.aspx.vb" MasterPageFile="MasterPage.master" Inherits="Admin_ClientListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" Runat="Server"> 
    ...
    <div class="span12">
        ...
        <asp:Label ID="lblHead" runat="server" style="margin-left:50%" Text="Client Listing"></asp:Label>
      </b>
        ...
        <ItemTemplate>
        <a href='clientprintappdetails.aspx?companyid=<%#Eval("companyid")%>' target="_blank" >Details</a>     
        </ItemTemplate>
        ...
        <asp:LinkButton ID="lnkDelete" CommandName="Delete" runat="server" CssClass="btn btn-danger " OnClientClick="return confirm('Do you really want to delete this row?')">
          <i class="btn-icon-only icon-cog"></i>Delete
        </asp:LinkButton>
                </center>
        </ItemTemplate>
        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="5%" />
