...
Partial Class Admin_printappdetails
    ...
    Private Sub showdata()
        strqry1 = "select * from director where dirid =" & Session("dirid").ToString()
    ...
    Protected Sub dlstMain_ItemDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataListItemEventArgs) Handles dlstMain.ItemDataBound
        ...
        Dim dinno = db.getFieldValue("director", "dirid", s, "dinno", True)
        ...
        strqry1 = "select * from director where dirid =" & s
        dt1 = db.fillReader1(strqry1)
        dr = dt1.CreateDataReader()
        If dr.Read() Then
    ...
    Protected Sub btnedit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnedit.Click
        Response.Redirect("SRegistration.aspx?dirid=" & Session("dirid").ToString())
    End Sub

    Protected Sub btnReconfirm_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReconfirm.Click
        Response.Redirect("SRegistration.aspx")
    End Sub

    Protected Sub btnpreview_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnpreview.Click
        Response.Redirect("printappdetails1.aspx?dirid=" & Session("dirid").ToString())
    End Sub
End Class
