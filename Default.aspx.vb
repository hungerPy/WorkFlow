...
Partial Public Class Admin_Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        Session("imagelogo") = db.getFieldValue("Company", "CompanyId", 1, "logo", True)
        Session("companyname") = db.getFieldValue("Company", "CompanyId", 1, "companyname", True)
        Session("companyid") = "1"
    End Sub
    ...
    Protected Sub btnlogin_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnlogin.Click
        ...
        objadmin.sessionid = Session("companyid")
