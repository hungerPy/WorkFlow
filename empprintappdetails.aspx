<%@ Page Language="VB" AutoEventWireup="false" CodeFile="empprintappdetails.aspx.vb" MasterPageFile="MasterPage.master" Inherits="empprintappdetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" Runat="Server">

    <title>Employee Edit Preview</title>
    </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" Runat="Server">
    <div>
        ...
        <b><span style=" font-size :large ; ">Employee Profile & Details</span> </b>
              
            </td></tr>
            <tr style="background-color :#E1E1E1 ; line-height:20px;">
            <td align="left"  colspan="4" style=" padding-left :10px;">Employee No. :<b> <%#DataBinder.Eval(Container.DataItem, "empno")%></b></td>
    ...
    <tr style="background-color :#EEEEEE ;" ><td colspan="4"  width="100%" align ="center" >
        ...
        <table  width="100%"><tr style="background-color :#E1E1E1 ;"><td align="center" ><asp:Button ID="btnReconfirm" runat="server" Text="Submit" width="100px" Height="20px"></asp:Button>&nbsp;&nbsp;<asp:Button ID="btnedit" width="70px" runat="server" Text="Edit" Height="20px"></asp:Button>&nbsp;&nbsp;<asp:Button ID="btnpreview" width="70px" runat="server" Text="Print" Height="20px"></asp:Button></td></tr></table>
    </div>
    </asp:Content>
